...
function toProposalAssociation(m: ProposalModel): ProposalAssociation {
  return new ProposalAssociation(m.ID, m.address, m.codOperator, m.holder, m.dependents, m.dateOfBirth, m.cpf, m.identity, m.proposalNumber, m.whatsapp,
...
function toProposalModel(e: ProposalAssociation): ProposalModel {
  return new ProposalModel(e.ID, e.address, e.codOperator, e.holder, e.dependents, e.dateOfBirth, e.cpf, e.identity, e.proposalNumber, e.whatsapp,
    ...
    e.plan, e.typeOfContract, e.office, e.broker, e.admFee, e.supervisor, true)
}
